...
def Green():
    ...
    # ['vendor_id', 'pickup_time', 'dropoff_time', 'store_and_fwd_flag',
    #    'rate_code_id', 'pickup_location_id', 'dropoff_location_id',
    #    'passengers', 'distance', 'fare', 'extra', 'mta_tax', 'tip',
    ...
    # table_id = f"{self.project_id}.{self.dataset_name}.{self.service}_tripdata"
